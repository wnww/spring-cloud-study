package com.yhhl.platform.intercept;
...
import com.yhhl.platform.rmi.RemoteCallService;
import com.yhhl.platform.transaction.Action;
import com.yhhl.platform.transaction.Activity;
...
public class TransactionIntercept {
	...
	// 定义通用的切入点，其它的通知可以共用
	@Pointcut("@annotation(com.yhhl.platform.annotation.TxTransaction) || execution(public * *(com.yhhl.platform.transaction.TxTransactionContext,..))")
